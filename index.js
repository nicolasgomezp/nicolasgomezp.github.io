( () => {
    var s = {
        482: (s, a) => {
            const r = "AKQJT98765432"
              ...
              , d = function(s, a, r, o) {
                const h = r / 2;
                let d = "";
                return d = "d" == s || "h" == s ? "#df0000" : "#000",
                $(`<div class='rounded playingcard border' id=${o} style='width: ${2 * r / 3}px;height: ${r}px; margin:2px'></div>`).append($(`<div class="text-center" style="width: 100%;height: 50%;color: ${d}"></div>`).append($(`<div style='font-size: ${h}px; line-height: 100%;'>${a}</div>`))).append($('<div class="text-center" style="width: 100%;height: 50%;"></div>').append(t[s]))
            }
              , e = function(s) {
            ...
            const i = function() {
                ...
                for (let t = 0; t < 4; t++) {
                    ...
                    for (let a = 0; a < 13; a++) {
                        const o = r[a]
                          , t = d(e, o, 40, `${s}_${o}${e}`);
                        h.has(o + e) ? t.addClass("selected") : t.click(p),
                        i.append(t)
                    }
                    a.append(i)
                }
        ...
        101: (s, a, r) => {
            ...
            a.qualifyCards = function(s, a) {
                    ...
                    if ("trips" === s) {
                        ...
                        if ("pair" === s) {
                            ...
                            if (w(a) && s)
                                return "overpair";
                            {
                                const s = (t = a.concat(...r),
                                g(t.map(o.getRankInt))[0])
                ...
                const $ = function(s, a, r) {
                    const t = []
                      , h = (d = a.concat(...r),
                    g(d.map(o.getSuitInt))[1]);
                    var d;
                    const e = function(s) {
                        (s = s.map(o.getRankInt)).indexOf(12) >= 0 && s.push(-1),
                        s = s.sort(( (s, a) => s - a));
                        let a = "";
                        for (let r = 0; r < s.length - 1; r++)
                            s[r + 1] - s[r] != 0 && (s[r + 1] - s[r] > 9 ? a += "9" : a += s[r + 1] - s[r]);
                    ...
                    return 4 === h ? (t.push("flushdraw"),
                    "pair" === s && t.push("flushdraw_pair"),
                    "oesd" === e ? t.push("flushdraw_oesd") : "gutshot" === e && t.push("flushdraw_gutshot")) : 3 === h && t.push("backdoorflushdraw"),
                    "oesd" === e ? (t.push("oesd"),
                    "pair" === s && t.push("oesd_pair")) : "gutshot" === e && (t.push("gutshot"),
                    "pair" === s ? t.push("gutshot_pair") : n(0, a, r) && t.push("gutshot_overcards")),
                    n(0, a, r) && t.push("overcards"),
                    t
                }(_, s, a);
        ...
        581: (s, a, r) => {
            ...
            a.calculateHandRangeEquity = function(s, a, r) {
                let t = 0
                  , d = 0
                  , e = 0;
                if (s = s.map(o.cardToInt),
                5 === (r = r.map(o.cardToInt)).length) {
                    ...
                    for (let s of a) {
                        ...
                        for (let a = 0; a < p.length; a++) {
                            const h = p[a];
                            if (h.includes(s[0]) || h.includes(s[1]))
                                continue;
                            const u = r.concat(h)
                              , l = i[a]
        ...
        284: (s, a, r) => {
            ...
            ;
            const u = function(s) {
                return [[s[0], s[1], s[2], s[3], s[4]], [s[0], s[1], s[2], s[3], s[5]], [s[0], s[1], s[2], s[3], s[6]], [s[0], s[1], s[2], s[4], s[5]], [s[0], s[1], s[2], s[4], s[6]], [s[0], s[1], s[2], s[5], s[6]], [s[0], s[1], s[3], s[4], s[5]], [s[0], s[1], s[3], s[4], s[6]], [s[0], s[1], s[3], s[5], s[6]], [s[0], s[1], s[4], s[5], s[6]], [s[0], s[2], s[3], s[4], s[5]], [s[0], s[2], s[3], s[4], s[6]], [s[0], s[2], s[3], s[5], s[6]], [s[0], s[2], s[4], s[5], s[6]], [s[0], s[3], s[4], s[5], s[6]], [s[1], s[2], s[3], s[4], s[5]], [s[1], s[2], s[3], s[4], s[6]], [s[1], s[2], s[3], s[5], s[6]], [s[1], s[2], s[4], s[5], s[6]], [s[1], s[3], s[4], s[5], s[6]], [s[2], s[3], s[4], s[5], s[6]]]
            }
              , p = function(s) {
                return [[s[0], s[1], s[2], s[3], s[4]], [s[0], s[1], s[2], s[3], s[5]], [s[0], s[1], s[2], s[4], s[5]], [s[0], s[1], s[3], s[4], s[5]], [s[0], s[2], s[3], s[4], s[5]], [s[1], s[2], s[3], s[4], s[5]]]
            };
        ...
        922: (s, a) => {
            ...
            const l = function() {
                ...
                const a = p($(this))
                  , r = $(`#${a}_range`).val();
                let o = "";
                o = 0 === h.length ? "0" : (parseInt(h[h.length - 1]) + 1).toString(),
                h.push(o),
                localStorage.setItem("RANGEINDICES", h.join()),
                localStorage.setItem("rn" + o, s),
                localStorage.setItem("r" + o, r),
                $(".customrangesgroup").append($(`<option id='${o}_user_range' class='${o}_user_range' value='${r}'>${s}</option>`)),
                $(`#${a}_rangeloaderselector`).val(`${r}`)
            }
              , c = function() {
                const s = p($(this))
                  , a = $("option:selected", $(`#${s}_rangeloaderselector`));
                if ("customrangesgroup" !== a.parent().attr("id"))
                    return;
                const r = a.attr("id").split("_")[0]
                  , o = h.indexOf(r);
                h.splice(o, 1),
                h.length > 0 ? localStorage.setItem("RANGEINDICES", h.join()) : localStorage.removeItem("RANGEINDICES"),
                localStorage.removeItem("rn" + r),
                localStorage.removeItem("r" + r),
                $(`.${r}_user_range`).remove()
            }
              , f = function() {
                const s = p($(this))
              ...
              , g = function(s) {
                const a = p($(this))
                  ...
                  , t = k(o);
                for (const s of r)
                    $(`#${a}_${s}`).removeClass("selected");
                t.forEach((s => $(`#${a}_${s}`).addClass("selected"))),
                T(a, !0),
                window.rangeUpdate(a)
            }
              , _ = function(s, a) {
                $(`#${s}_range`).val(a);
                const o = k(a);
                for (const a of r)
                    $(`#${s}_${a}`).removeClass("selected");
                o.forEach((a => $(`#${s}_${a}`).addClass("selected"))),
                T(s, !0),
                window.rangeUpdate(s)
            }
              , k = function(s) {
              ...
              , b = function(s) {
                ...
                if (s[0] === s[1])
                    ...
                    for (let t = o.indexOf(s[0]) + 1; t <= r; t++)
                        a.push(s[0] + o[t] + s[2].toLowerCase());
                return a
            }
              , m = function(s) {
                const a = []
              ...
              , q = function(s) {
                ...
                if (t[0] === t[1])
                    ...
                    for (let s = e; s <= d; s++)
                        a.push(t[0] + o[s] + t[2].toLowerCase());
                return a
            }
              , x = function(s) {
                let a = ""
                  ...
                  , h = "";
                for (let d = 0; d <= 12; d++)
                    $(`#${s}_${o[d]}${o[d]}`).hasClass("selected") ? (r || (r = !0,
                    t = o[d] + o[d]),
                    h = o[d] + o[d]) : (r && (a += t === h ? h + ", " : "AA" === t ? h + "+, " : h + "-" + t + ", "),
                    r = !1);
                r && (a += t === h ? h + ", " : "AA" === t ? h + "+, " : t + "-, ");
                for (let d = 0; d <= 11; d++) {
                    r = !1,
                    ...
                    for (let e = d + 1; e <= 12; e++)
                        $(`#${s}_${o[d]}${o[e]}s`).hasClass("selected") ? (r || (r = !0,
                        t = o[d] + o[e] + "s"),
                        h = o[d] + o[e] + "s") : (r && (t === h ? a += h + ", " : t === o[d] + o[d + 1] + "s" ? a += h + "+, " : a += h + "-" + t + ", "),
                        r = !1);
                ...
                for (let d = 0; d <= 11; d++) {
                    ...
                    h = "";
                    for (let e = d + 1; e <= 12; e++)
                        $(`#${s}_${o[d]}${o[e]}o`).hasClass("selected") ? (r || (r = !0,
                        t = o[d] + o[e] + "o"),
                        h = o[d] + o[e] + "o") : (r && (t === h ? a += h + ", " : t === o[d] + o[d + 1] + "o" ? a += h + "+, " : a += h + "-" + t + ", "),
                        r = !1);
                    r && (t === h ? a += h + ", " : t === o[d] + o[d + 1] + "o" ? a += h + "+, " : a += t + "-, ")
                }
                a.length > 2 && (a = a.slice(0, -2)),
                $(`#${s}_range`).val(a)
            }
              , y = function(s) {
                const a = s.from
                ...
                let h = 0;
                for (const s of r)
                    $(`#${t}_${s}`).removeClass("selected");
                for (const s of r)
                    if (s[0] === s[1] ? h += 6 : "s" === s[2] ? h += 4 : h += 12,
                    h > a && h <= o && $(`#${t}_${s}`).addClass("selected"),
                    h > o)
                        break;
                x(t),
                T(t, !1),
                window.rangeUpdate(t)
            }
              , T = function(s, a) {
                let o = 0
                  , t = 0
                  , h = !0;
                for (const a of r)
                    if ($(`#${s}_${a}`).hasClass("selected"))
                        h = !1,
                        a[0] === a[1] ? o += 6 : "s" === a[2] ? o += 4 : o += 12;
                    else {
                        let s = 0;
                        s = a[0] === a[1] ? 6 : "s" === a[2] ? 4 : 12,
                        h && (t += s)
                    }
                1326 === t && (t = 0);
                const d = (t / 1326 * 100).toFixed(1) + "%"
                  , e = (o / 1326 * 100).toFixed(1) + "%";
                $(`#${s}_percent`).text("R: " + d + ", C: " + e),
                $(`#${s}_percent_display`).text(e),
                a && $(`#${s}_slider`).data("ionRangeSlider").update({
                    from: t,
                    to: t + o
                })
            };
            a.buildRange = function(s, a) {
                ...
                const k = function(s) {
                    ...
                    for (let r = 0; r < 13; r++) {
                        ...
                        for (let a = 0; a < 13; a++) {
                            let h = ""
                              , d = "";
                            r === a ? (h = o[r] + o[a],
                            d = n(`${s}_${h}`, h, "pocketpair")) : r < a ? (h = o[r] + o[a] + "s",
                            d = n(`${s}_${h}`, h, "suited")) : (h = o[a] + o[r] + "o",
                            d = n(`${s}_${h}`, h, "offsuit")),
                            t.append(d)
                        }
                        a.append(t)
                  ...
                  , v = function(s) {
                    ...
                    for (let s = 0; s < d.length; s++)
                        t.append(`<option id='${h[s]}_user_range' class='${h[s]}_user_range' value='${e[s]}'>${d[s]}</option>`);
                    o.append(t);
                    const p = $('<optgroup label="6-Max Opening Ranges"></optgroup>');
                    for (const s in i)
                        p.append(`<option id='sixmax_${s}' value='${i[s]}'>${s}</option>`);
                    o.append(p);
                    const w = $('<optgroup label="9-Max Opening Ranges"></optgroup>');
                    for (const s in u)
                        w.append(`<option id='ninemax_${s}' value='${u[s]}'>${s}</option>`);
                    o.append(w);
                ...
                return p.on("keyup", g),
                $(`<div id='${a}_player' class='col-5 player p-3'></div>`).append(r).append(p).append(w).append(k).append(v)
            }
            ;
            const A = function(s) {
                const a = [];
            ...
            a.getPlayerHands = function(s) {
                try {
                    ...
                    const o = [];
                    for (const a of r)
                        $(`#${s}_${a}`).hasClass("selected") && o.push(a);
                    const t = A(o);
                    if (t.length > 0)
                        return t;
            ...
            a.getHands = function(s) {
                const a = [];
                for (const o of r)
                    $(`#${s}_${o}`).hasClass("selected") && a.push(o);
                return A(a)
            }
        }
    }
    ...
    ( () => {
        const s = r(101)
          ...
          , c = function(s) {
            ...
            if (0 === r)
                for (const s in a)
                    $(`#preflop_${s}_meter`).val(0),
                    $(`#preflop_${s}_percent`).text((0).toFixed(1) + "%");
            else
                for (const s in a) {
                    const o = a[s];
                    $(`#preflop_${s}_meter`).val(1e3 * o / r),
                    $(`#preflop_${s}_percent`).text((100 * o / r).toFixed(1) + "%")
                }
            q(0),
            A()
        }
          ...
          , g = function(s) {
            let a, r;
            return a = "h" === s[0][1] || "d" === s[0][1] ? `<span style='color:red'>${s[0][0]}${l[s[0][1]]}</span>` : `<span style='color:black'>${s[0][0]}${l[s[0][1]]}</span>`,
            r = "h" === s[1][1] || "d" === s[1][1] ? `<span style='color:red'>${s[1][0]}${l[s[1][1]]}</span>` : `<span style='color:black'>${s[1][0]}${l[s[1][1]]}</span>`,
            a + r
        }
          , _ = function(a, r, o, t) {
            const h = []
              , d = function(s) {
                const a = new Set;
                for (const r of e)
                    $(`#${s}_${r}_box`).prop("checked") && a.add(r);
                return a
            }(a)
              , i = {};
            let u = 0;
            ...
            for (const s in i) {
                const r = i[s];
                $(`#${a}_${s}_meter`).val(1e3 * r / u),
                $(`#${a}_${s}_percent`).text((100 * r / u).toFixed(1) + "%")
            }
            return $(`#${a}_combos`).text(h.length),
            $(`#${a}_combos_percent`).text((h.length / u * 100).toFixed(1) + "%"),
            function(s, a) {
        ...
        const q = function(s) {
            ...
            const o = f()
              ...
              , h = new Set(t);
            for (const s of r)
                h.has(s[0]) || h.has(s[1]) || k.push(s);
            const d = "empty" !== o[0] && "empty" !== o[1] && "empty" !== o[2]
              , e = d && "empty" !== o[3]
              , i = e && "empty" !== o[4];
            return d && r.length > 0 ? v = _("flop", r, o.slice(0, 3), t) : x("flop"),
            e && v.length > 0 ? b = _("turn", v, o.slice(0, 4), t) : x("turn"),
            i && b.length > 0 ? m = _("river", b, o, t) : x("river")
        }
          , x = function(s) {
            for (const a of e)
                $(`#${s}_${a}_meter`).val(0),
                $(`#${s}_${a}_percent`).text((0).toFixed(1) + "%");
            $(`#${s}_combos_all`).empty()
        }
          , y = function(s) {
            const a = s.target.id.slice(0, -4);
            $(s.target).prop("checked") && $(`.${a}_subqualifier`).prop("checked", $(s.target).prop("checked")),
            c()
        }
          , T = function(s) {
            ...
            o ? $(`#${a.slice(0, -13)}_box`).prop("checked", !0) : $(`#${a.slice(0, -13)}_box`).prop("checked", !1),
            c()
        };
        ...
        $("#calc_equity").click((function(s) {
            if (!s.detail || 1 === s.detail) {
                ...
                if ("empty" === s[0] || "empty" === s[1])
                    return void C("Missing <strong>Hole Cards</strong>");
                if (0 === k.length)
                    return void C("No hands in <strong>Range</strong>");
                const a = f()
                  , r = "empty" !== a[0] && "empty" !== a[1] && "empty" !== a[2]
                  , o = r && "empty" !== a[3]
                  , h = o && "empty" !== a[4];
                $("#calc_equity").prepend($('<span id="equity_spinner" class="spinner-border spinner-border-sm mr-2" role="status" aria-hidden="true"></span>')),
                $("#calc_equity").attr("disabled", !0),
                setTimeout(( () => {
                    let d = t.approximateHandRangeEquity(s, k, 1e4);
                    $("#preflop_equity").text("~" + (100 * d[0]).toFixed(1) + "%"),
                    r && (d = t.calculateHandRangeEquity(s, v, a.slice(0, 3)),
                    $("#flop_equity").text((100 * d[0]).toFixed(1) + "%")),
                    o && (d = t.calculateHandRangeEquity(s, b, a.slice(0, 4)),
                    $("#turn_equity").text((100 * d[0]).toFixed(1) + "%")),
                    h && (d = t.calculateHandRangeEquity(s, m, a),
                    $("#river_equity").text((100 * d[0]).toFixed(1) + "%")),
        ...
        $("#nav-preflop-tab").click(J),
        $("#nav-flop-tab").click(J),
        $("#nav-turn-tab").click(J),
        $("#nav-river-tab").click(J),
        a.loadRanges(),
        function() {
            const s = a.buildRange("Range", 0);
            s.addClass("mx-auto"),
            $("#player_0").replaceWith(s),
            function() {
                for (const s of ["preflop", "flop", "turn", "river"]) {
                    let a = "made";
                    for (const r of i) {
                        "straightflush" === r ? $(`#${s}_body`).append("<tr><td colspan=4><i>Made Hands</i></td></tr>") : "flushdraw" === r && (a = "draw",
                        $(`#${s}_body`).append("<tr><td colspan=4><i>Draws</i></td></tr>"));
                        let o = $("<tr></tr>");
                        if ("preflop" === s ? o.append('<td style="width: 13px"></td>') : "river" === s && "draw" === a || "turn" === s && "backdoorflushdraw" === r ? o.append($('<td style="width: 13px"></td>').append($(`<input type='checkbox' id='${s}_${r}_box'>`).change(y))) : o.append($('<td style="width: 13px"></td>').append($(`<input type='checkbox' id='${s}_${r}_box' checked>`).change(y))),
                        o.append(`<td class='pl-1 pr-xl-3 stats_hand_qualifier'>${p[r]}</td>`).append(`<td id='${s}_${r}_percent' class='stats_hand_percent'>0.0%</td>`).append(`<td class='stats_hand_meter'><meter id='${s}_${r}_meter' value=0 min=0 max=1000 style='width: 100%'></meter></td>`),
                        $(`#${s}_body`).append(o),
                        r in u)
                            for (const t of u[r])
                                o = $('<tr class="subqualifier"></tr>'),
                                "preflop" === s ? (o.append('<td style="width: 13px"></td>'),
                                o.append(`<td class='pl-3 pr-xl-3 stats_hand_qualifier'>${p[t]}</td>`).append(`<td id='${s}_${t}_percent' class='stats_hand_percent'>0.0%</td>`).append(`<td class='stats_hand_meter'><meter id='${s}_${t}_meter' value=0 min=0 max=1000 style='width: 100%'></meter></td>`)) : "river" === s && "draw" === a ? (o.append('<td style="width: 13px"></td>'),
                                o.append($(`<td class='pr-xl-3 stats_hand_qualifier'>&nbsp;&nbsp;${p[t]}</td>`).prepend($(`<input type='checkbox' id='${s}_${t}_box' class='${s}_${r}_subqualifier'>`).change(T))).append(`<td id='${s}_${t}_percent' class='stats_hand_percent'>0.0%</td>`).append(`<td class='stats_hand_meter'><meter id='${s}_${t}_meter' value=0 min=0 max=1000 style='width: 100%'></meter></td>`)) : (o.append('<td style="width: 13px"></td>'),
                                o.append($(`<td class='pr-xl-3 stats_hand_qualifier'>&nbsp;&nbsp;${p[t]}</td>`).prepend($(`<input type='checkbox' id='${s}_${t}_box' class='${s}_${r}_subqualifier' checked>`).change(T))).append(`<td id='${s}_${t}_percent' class='stats_hand_percent'>0.0%</td>`).append(`<td class='stats_hand_meter'><meter id='${s}_${t}_meter' value=0 min=0 max=1000 style='width: 100%'></meter></td>`)),
                                $(`#${s}_body`).append(o)
                    }
                }
            }()
        ...
        o.addCardSelect(U),
        $("#hole_cards").prepend(H, U),
        $("#random_board").click((function() {
            return o.setCardRandom("board1"),
            o.setCardRandom("board2"),
            o.setCardRandom("board3"),
            o.setCardRandom("board4"),
            o.setCardRandom("board5"),
            c()
        }
        )),
        $("#clear_board").click((function() {
            return o.resetCard("board1"),
            o.resetCard("board2"),
            o.resetCard("board3"),
            o.resetCard("board4"),
            o.resetCard("board5"),
        ...
        $("#flop_combos_all").on("shown.bs.collapse", c),
        $("#turn_combos_all").on("shown.bs.collapse", c),
        $("#river_combos_all").on("shown.bs.collapse", c)
    }
    )()
}
)();
